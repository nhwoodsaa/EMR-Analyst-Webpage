// Function to retrieve the analyst name from local storage
        ...
        function showDetail(tileNumber) {
			...
			// Core Responses [Prefix 2xxx]
				...
				2012: "This patient was discharged as part of the Short Cross-Campus Admission workflow however they remained at the receiving campus longer than 24 hours. In this case you will need to change the discharge method within iPM for the patient to Other Hospital. More information about this process can be found within this QRG: https://emr-media.nh.org.au/wp-content/uploads/2023/08/Administration-Short-Cross-Campus-Admission.pdf.",
				2013: "The discharge method for this patient within iPM is 'Re-admit within 24hrs to this hospital planned' which will leave the encounter open in the EMR. If this was done incorrectly and the patient is actually discharged from Northern Health please update the discharge method within iPM. Please see this QRG for more information on this process: https://emr-media.nh.org.au/wp-content/uploads/2023/08/Administration-Short-Cross-Campus-Admission.pdf.",
